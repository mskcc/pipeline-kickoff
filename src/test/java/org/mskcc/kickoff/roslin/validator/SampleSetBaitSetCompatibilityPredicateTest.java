...
public class SampleSetBaitSetCompatibilityPredicateTest {
    ...
    public static void init() {
        List<SampleSetBaitSetCompatibilityPredicate.Pair<String>> compatibility = Arrays.asList(
                new SampleSetBaitSetCompatibilityPredicate.Pair<>(IMPACT_341.getValue(), IMPACT_410.getValue()),
                new SampleSetBaitSetCompatibilityPredicate.Pair<>(IMPACT_341.getValue(), IMPACT_468.getValue()),
                new SampleSetBaitSetCompatibilityPredicate.Pair<>(IMPACT_410.getValue(), IMPACT_468.getValue())
        );
