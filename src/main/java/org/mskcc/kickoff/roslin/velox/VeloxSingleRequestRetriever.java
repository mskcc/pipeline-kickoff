...
import org.mskcc.kickoff.roslin.lims.SampleInfoExome;
import org.mskcc.kickoff.roslin.lims.SampleInfoImpact;
import org.mskcc.kickoff.logger.PmLogPriority;
import org.mskcc.kickoff.roslin.poolednormals.PooledNormalsRetriever;
import org.mskcc.kickoff.roslin.poolednormals.PooledNormalsRetrieverFactory;
import org.mskcc.kickoff.roslin.process.ForcedProcessingType;
import org.mskcc.kickoff.roslin.process.ProcessingType;
import org.mskcc.kickoff.roslin.retriever.NimblegenResolver;
import org.mskcc.kickoff.roslin.retriever.SequencerIdentifierRetriever;
import org.mskcc.kickoff.roslin.retriever.SingleRequestRetriever;
...
public class VeloxSingleRequestRetriever implements SingleRequestRetriever {
    ...
    private List<Long> getPassingSeqRuns(KickoffRequest kickoffRequest, DataRecord dataRecordRequest) {
        ...
        try {
            ...
            if (sampleQCList.size() == 0 && Arguments.forced && !kickoffRequest.isManualDemux())
