...
import static org.mskcc.kickoff.bic.velox.util.VeloxConstants.CMO_SAMPLE_CLASS;
import static org.mskcc.kickoff.bic.velox.util.VeloxConstants.TUMOR_OR_NORMAL;
...
public class SampleInfoImpact extends SampleInfo {
     ...
     **/
    public SampleInfoImpact(User apiUser, DataRecordManager drm, DataRecord rec, KickoffRequest request, Sample sample) {
     ...
     * BLAH
     **/
    void addPooledNormalDefaults(DataRecord rec, User apiUser, DataRecordManager drm, KickoffRequest request) {
    ...
    private String getPooledNormalRuns(DataRecord rec, User apiUser, DataRecordManager drm, KickoffRequest request) {
    ...
    void getSpreadOutInfo(User apiUser, DataRecordManager drm, DataRecord rec, KickoffRequest request, Sample sample) {
    ...
    void getBarcodeInfo(DataRecordManager drm, User apiUser, KickoffRequest request, Sample sample) {
    ...
    double getLibraryConcentration(DataRecord rec, DataRecordManager drm, User apiUser, Boolean transfer, String alternativeDR) {
    ...
    private void processNimbInfo(DataRecordManager drm, DataRecord rec, User apiUser, double libVol, double libConc,
                                 boolean poolNormal, boolean afterDate, Sample sample, KickoffRequest request) {
    ...
    private void populatePoolNormals(User apiUser, DataRecordManager dataRecordManager, KickoffRequest request) {
        try {
    ...
    private boolean isSampleRun(DataRecord potentialPooledNormalQc, User apiUser, KickoffRequest request)
            throws Exception {
