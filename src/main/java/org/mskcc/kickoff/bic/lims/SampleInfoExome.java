...
public class SampleInfoExome extends SampleInfoImpact {
    ...
    public SampleInfoExome(User apiUser, DataRecordManager drm, DataRecord rec, KickoffRequest request, Sample sample) {
    ...
    @Override
    protected void getSpreadOutInfo(User apiUser, DataRecordManager drm, DataRecord rec, KickoffRequest request, Sample sample) {
