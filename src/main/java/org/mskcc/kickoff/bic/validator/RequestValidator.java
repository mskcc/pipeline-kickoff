...
import org.mskcc.kickoff.bic.domain.QcStatus;
...
public class RequestValidator {
    ...
    public void validate(KickoffRequest request) {
...
//        validateNimbleGen(request);
    ...
    private void validateOutputDir(KickoffRequest request) {
    ...
    private void validateNimbleGen(KickoffRequest request) {
    ...
    public void validateSampleUniqueness(KickoffRequest request) {
    ...
    private Set<Sample> getDuplicateSamples(KickoffRequest request) {
    ...
    private void validateBarcodeInfo(KickoffRequest request) {
...
*/
    ...
    private void validateSampSpecificQc(KickoffRequest request) {
    ...
    private void validatePoolSeqQc(KickoffRequest request) {
    ...
    private void validateAutoGenerability(KickoffRequest request) {
    ...
    private void validatePostSeqQC(KickoffRequest request) {
    ...
    private void validateReadCounts(KickoffRequest request) {
    ...
    private Collection<Sample> getSamplesWithSampleQc(KickoffRequest request) {
        return request.getSamples(s -> s.getRuns().values().stream().anyMatch(r -> r.getSampleLevelQcStatus() == QcStatus.PASSED)).values();
    }

    private void validateSampleQcAgainstPoolQC(KickoffRequest request) {
    ...
    public void validateSamplesExist(KickoffRequest request) {
