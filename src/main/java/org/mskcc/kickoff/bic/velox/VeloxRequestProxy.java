package org.mskcc.kickoff.bic.velox;
...
import org.mskcc.kickoff.bic.domain.*;
...
import org.mskcc.kickoff.bic.lims.SampleInfo;
import org.mskcc.kickoff.bic.lims.SampleInfoExome;
import org.mskcc.kickoff.bic.lims.SampleInfoImpact;
import org.mskcc.kickoff.logger.PmLogPriority;
import org.mskcc.kickoff.bic.process.ForcedProcessingType;
import org.mskcc.kickoff.bic.process.NormalProcessingType;
...
import org.mskcc.kickoff.bic.velox.util.VeloxConstants;
import org.mskcc.kickoff.bic.velox.util.VeloxUtils;
...
import static org.mskcc.kickoff.bic.util.Utils.getJoinedCollection;
...
public class VeloxRequestProxy implements RequestProxy {
    ...
    private User user;
    private List<KickoffRequest> requests = new ArrayList<>();
    ...
    @Override
    public List<KickoffRequest> getRequests(String requestId) {
        initVeloxConnection();
    ...
    private void retrieveRequest(String requestId) {
        try {
            ...
            for (DataRecord dataRecordRequest : requestsDataRecords) {
                ...
                KickoffRequest request = new KickoffRequest(requestId, new NormalProcessingType(projectFilesArchiver));
    ...
    private void setReadMe(KickoffRequest request, DataRecord dataRecordRequest) {
        String readMe = "";
        try {
    ...
    private void setName(KickoffRequest request, DataRecord dataRecordRequest) {
        String requestName = "";
        try {
    ...
    private void setRecipe(KickoffRequest request, DataRecord dataRecordRequest) {
    ...
    private void addPoolRunsToSamples(KickoffRequest request) {
    ...
    private void addSampleInfo(KickoffRequest request) {
    ...
    private boolean validateSequencingRuns(KickoffRequest request) {
    ...
    private void setProperties(KickoffRequest request, DataRecord dataRecordRequest) {
    ...
    private void setPairings(KickoffRequest request, DataRecord dataRecordRequest) {
        try {
...
//                pairing.setIsTumor(true);
    ...
    private void processPooledNormals(KickoffRequest request, DataRecord dataRecordRequest) {
        try {
    ...
    private Sample getPooledNormal(KickoffRequest request, String cmoNormalId) {
        return request.getSamples().values().stream().filter(s -> s.getCmoSampleId().equals(cmoNormalId)).findFirst().get();
    }

    private boolean hasPooledNormal(KickoffRequest request, String cmoNormalId) {
    ...
    private Set<Run> getPooledNormalRuns(Set<String> pooledNormalPools, KickoffRequest request) {
    ...
    private void setReqType(KickoffRequest request) {
    ...
    private void processSamples(KickoffRequest request, DataRecord dataRecordRequest) {
        try {
    ...
    private void processSample(KickoffRequest request, DataRecord dataRecordSample) throws NotFound, RemoteException, IoError {
    ...
    private void processPlates(KickoffRequest request, DataRecord dataRecordRequest) {
        try {
    ...
    private void addSampleQcInformation(KickoffRequest request, Sample sample) {
        try {
    ...
    private void addPoolRunsToSample(KickoffRequest request, Sample sample) {
    ...
    private void addPoolSeqQc(KickoffRequest request, DataRecord dataRecordRequest, Collection<DataRecord> samplesToAddPoolQc) {
        try {
    ...
    private void getLibTypes(KickoffRequest request, DataRecord dataRecordRequest) {
        try {
    ...
    private void checkSamplesForLibTypes(KickoffRequest request, Set<DataRecord> finalSampleList) {
        try {
    ...
    private List<Long> getPassingSeqRuns(KickoffRequest request, DataRecord dataRecordRequest) {
    ...
    private LinkedHashMap<String, String> getSampleInfoMap(DataRecord dataRecord, Sample sample, KickoffRequest request) {
