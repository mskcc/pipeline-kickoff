...
import org.mskcc.kickoff.bic.generator.PairingsResolver;
...
public class PairingFilePrinter implements FilePrinter {
    ...
    public boolean shouldPrint(KickoffRequest request) {
        return !(Utils.isExitLater() && !request.isInnovationProject() && !request.getRequestType().equals(Constants.OTHER) && !request.getRequestType().equals(Constants.RNASEQ))
