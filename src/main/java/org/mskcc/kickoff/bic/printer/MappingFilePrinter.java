...
public class MappingFilePrinter implements FilePrinter {
    ...
    private void backupOldMapping(KickoffRequest request, String mappingFileName, String mappingFilePath, String
            mappingFileContents) {
        try {
    ...
    private void sendNotification(String requestId, String mappingFilePath) {
