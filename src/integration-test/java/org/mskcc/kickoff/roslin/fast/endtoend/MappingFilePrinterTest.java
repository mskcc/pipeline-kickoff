...
import org.mskcc.kickoff.roslin.fast.sampleset.SampleSetIntegrationTest;
import org.mskcc.kickoff.roslin.lims.ProjectInfoRetriever;
import org.mskcc.kickoff.roslin.lims.SampleInfo;
import org.mskcc.kickoff.roslin.printer.MappingFilePrinter;
...
import org.mskcc.kickoff.roslin.validator.PairednessValidPredicate;
    ...
    private Map<String, Set<String>> getSampleRuns(KickoffRequest singleRequest) {
        ...
        for (Sample sample : singleRequest.getAllValidSamples().values()) {
            for (String runId : sample.getValidRunIds()) {
                ...
                String sampleName = Utils.sampleNormalization(sampleRenamesAndSwaps.getOrDefault(sampleId,
                        sampleId));
