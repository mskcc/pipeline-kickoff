...
import org.mskcc.kickoff.comparator.*;
import org.mskcc.kickoff.listener.ActualOutputFailingTestListener;
import org.mskcc.kickoff.listener.ArchiveOutputFailingTestListener;
import org.mskcc.kickoff.listener.ExpectedOutputFailingTestListener;
import org.mskcc.kickoff.listener.FailingNumberOfFilesListener;
...
public class RegressionTest {
    ...
    private void assertProjectAndLogDirExists(Path actualOutputPath) {
        ...
        MatcherAssert.assertThat(logDir.getName(), CoreMatchers.is(Constants.LOG_FILE_PATH));
